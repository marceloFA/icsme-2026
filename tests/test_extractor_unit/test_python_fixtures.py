...
class TestExample(unittest.TestCase):
    def setUp(self):
        self.data = []
"""
        assert_fixture_detected(code, 'python', 'setUp', fixture_type='unittest_setup', scope='per_test')
...
class TestExample(unittest.TestCase):
    def tearDown(self):
        self.data.clear()
"""
        assert_fixture_detected(code, 'python', 'tearDown', fixture_type='unittest_setup', scope='per_test')
...
def sample_data():
    return {"key": "value"}
"""
        fixture = assert_fixture_detected(code, 'python', 'sample_data', fixture_type='pytest_decorator')
...
async def async_database():
    ...
    await db.close()
"""
        fixture = assert_fixture_detected(code, 'python', 'async_database', fixture_type='pytest_decorator', scope='per_test')
...
"""
        fixture = assert_fixture_detected(code, 'python', 'async_service', fixture_type='pytest_decorator', scope='per_module')
...
async def async_configured_db(request):
    ...
    await db.disconnect()
"""
        fixture = assert_fixture_detected(code, 'python', 'async_configured_db', fixture_type='pytest_decorator', scope='per_test')
...
"""
        fixture = assert_fixture_detected(code, 'python', 'setup_module', fixture_type='nose_fixture', scope='per_module')
...
"""
        fixture = assert_fixture_detected(code, 'python', 'teardown_module', fixture_type='nose_fixture', scope='per_module')
...
"""
        fixture = assert_fixture_detected(code, 'python', 'setup', fixture_type='nose_fixture', scope='per_test')
...
"""
        fixture = assert_fixture_detected(code, 'python', 'teardown', fixture_type='nose_fixture', scope='per_test')
...
"""
        fixture = assert_fixture_detected(code, 'python', 'setUpClass', fixture_type='unittest_setup', scope='per_class')
...
"""
        fixture = assert_fixture_detected(code, 'python', 'setup_method', fixture_type='pytest_class_method', scope='per_test')
